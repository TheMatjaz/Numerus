 ...
 *
 * short_to_roman() cannot convert the passed value because it exceed the
 * possible values a roman numeral may represent, which are the integers in the
 * interval [ROMAN_MIN_VALUE, ROMAN_MAX_VALUE].
 */
 ...
 * converted to short by roman_to_short(). Check regerror() and the stderr for
 * more information.
 */
...
/**
 * roman_is_bigger() comparision failed.
 *
